...
function setupMockWorker(mod) {
    ...
    return {
        ...
        /** Simulate Worker resolved message [0, ops, effects, firstAfterReconnect, azNames] */
...
// Worker sends [0, ops|null, effects|null, firstAfterReconnect, azNames|null] to main.
// ---------------------------------------------------------------------------
