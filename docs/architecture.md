...
| `src/arizona_middleware.erl`              | Request-to-bindings middleware pipeline -- `apply_middlewares/3` runner, built-in steps (`extract/1`, `check_origin/2`, ...) + the HTTP response transform constructors (`etag/0`, ...)   |
