...
var J = 11;
function ce(n, e) {
  var t = e.attributes, r, s, l, h, g;
  if (!(e.nodeType === J || n.nodeType === J)) {
    for (var p = t.length - 1; p >= 0; p--)
      r = t[p], s = r.name, l = r.namespaceURI, h = r.value, l ? (s = r.localName || s, g = n.getAttributeNS(l, s), g !== h && (r.prefix === "xmlns" && (s = r.name), n.setAttributeNS(l, s, h))) : (g = n.getAttribute(s), g !== h && n.setAttribute(s, h));
...
function me(n) {
  return function(t, r, s) {
    ...
    var h = s.getNodeKey || ye, g = s.onBeforeNodeAdded || w, p = s.onNodeAdded || w, b = s.onBeforeElUpdated || w, T = s.onElUpdated || w, ee = s.onBeforeNodeDiscarded || w, L = s.onNodeDiscarded || w, te = s.onBeforeElChildrenUpdated || w, re = s.skipFromChildren || w, V = s.addChild || function(i, a) {
    ...
    function O(i, a, d) {
      ...
      if (c && delete k[c], !d) {
        var o = b(i, a);
        if (o === !1 || (o instanceof HTMLElement && (i = o, I(i)), n(i, a), T(i), te(i, a) === !1))
          return;
      }
    ...
    function ne(i, a) {
      ...
      e: for (; c; ) {
        ...
        if (S && (y = k[S]) && _(y, c))
          ...
          var W = g(c);
          W !== !1 && (W && (c = W), c.actualize && (c = c.actualize(i.ownerDocument || f)), V(i, c), z(c));
        }
        c = C, o = M;
      }
      se(i, o, v);
    ...
    if (!x) {
      if (N === A)
        F === A ? _(t, r) || (L(t), u = ve(t, pe(r.nodeName, r.namespaceURI))) : u = r;
      else if (N === q || N === Y) {
        if (F === N)
...
class be {
  ...
  connect(e) {
    ...
    const t = window.location.protocol === "https:" ? "wss:" : "ws:", r = window.location.host, s = window.location.pathname, l = window.location.search, h = encodeURIComponent(s), g = l ? encodeURIComponent(l.substring(1)) : "", p = `${t}//${r}${e}?path=${h}&qs=${g}`;
    this.worker.postMessage({
      type: "connect",
      data: { url: p, expectedHost: r }
    });
  }
  /**
