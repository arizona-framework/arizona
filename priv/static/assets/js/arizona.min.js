...
function le(n, e) {
  ...
  if (!(e.nodeType === K || n.nodeType === K)) {
    ...
    for (var m = n.attributes, M = m.length - 1; M >= 0; M--)
      a = m[M], r = a.name, o = a.namespaceURI, o ? (r = a.localName || r, e.hasAttributeNS(o, r) || n.removeAttributeNS(o, r)) : e.hasAttribute(r) || n.removeAttribute(r);
  }
}
...
function be(n) {
  return function(t, a, r) {
    ...
    var d = r.getNodeKey || we, g = r.onBeforeNodeAdded || w, b = r.onNodeAdded || w, m = r.onBeforeElUpdated || w, M = r.onElUpdated || w, te = r.onBeforeNodeDiscarded || w, R = r.onNodeDiscarded || w, ae = r.onBeforeElChildrenUpdated || w, ne = r.skipFromChildren || w, V = r.addChild || function(i, s) {
    ...
    function P(i) {
      ...
      for (var s = i.firstChild; s; ) {
        ...
        if (c) {
          var l = k[c];
          l && _(s, l) ? (s.parentNode.replaceChild(l, s), z(l, s)) : P(s);
        } else
          P(s);
        s = h;
      }
    ...
    function z(i, s, h) {
      ...
      if (c && delete k[c], !h) {
        var l = m(i, s);
        if (l === !1 || (l instanceof HTMLElement && (i = l, I(i)), n(i, s), M(i), ae(i, s) === !1))
          return;
      }
      i.nodeName !== "TEXTAREA" ? ie(i, s) : X.TEXTAREA(i, s);
    }
    function ie(i, s) {
      var h = ne(i, s), c = s.firstChild, l = i.firstChild, S, p, A, E, v;
      e: for (; c; ) {
        for (E = c.nextSibling, S = d(c); !h && l; ) {
          if (A = l.nextSibling, c.isSameNode && c.isSameNode(l)) {
            c = E, l = A;
            continue e;
          }
          p = d(l);
          var H = l.nodeType, y = void 0;
          if (H === c.nodeType && (H === T ? (S ? S !== p && ((v = k[S]) ? A === v ? y = !1 : (i.insertBefore(v, l), p ? O(p) : N(
            l,
            i,
            !0
            /* skip keyed nodes */
          ), l = v, p = d(l)) : y = !1) : p && (y = !1), y = y !== !1 && _(l, c), y && z(l, c)) : (H === Y || H == Z) && (y = !0, l.nodeValue !== c.nodeValue && (l.nodeValue = c.nodeValue))), y) {
            c = E, l = A;
            continue e;
          }
          p ? O(p) : N(
    ...
    if (!x) {
      if (D === T)
        Q === T ? _(t, a) || (R(t), u = ye(t, ve(a.nodeName, a.namespaceURI))) : u = a;
      else if (D === Y || D === Z) {
        if (Q === D)
