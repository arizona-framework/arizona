...
var J = 11;
function oe(n, e) {
  var t = e.attributes, r, s, l, f, p;
  if (!(e.nodeType === J || n.nodeType === J)) {
    for (var d = t.length - 1; d >= 0; d--)
      r = t[d], s = r.name, l = r.namespaceURI, f = r.value, l ? (s = r.localName || s, p = n.getAttributeNS(l, s), p !== f && (r.prefix === "xmlns" && (s = r.name), n.setAttributeNS(l, s, f))) : (p = n.getAttribute(s), p !== f && n.setAttribute(s, f));
    for (var b = n.attributes, T = b.length - 1; T >= 0; T--)
      r = b[T], s = r.name, l = r.namespaceURI, l ? (s = r.localName || s, e.hasAttributeNS(l, s) || n.removeAttributeNS(l, s)) : e.hasAttribute(s) || n.removeAttribute(s);
  }
}
var E, he = "http://www.w3.org/1999/xhtml", g = typeof document > "u" ? void 0 : document, de = !!g && "content" in g.createElement("template"), ue = !!g && g.createRange && "createContextualFragment" in g.createRange();
function fe(n) {
  var e = g.createElement("template");
  return e.innerHTML = n, e.content.childNodes[0];
}
function ge(n) {
  E || (E = g.createRange(), E.selectNode(g.body));
  var e = E.createContextualFragment(n);
...
function ve(n) {
  return n = n.trim(), de ? fe(n) : ue ? ge(n) : pe(n);
}
function _(n, e) {
  var t = n.nodeName, r = e.nodeName, s, l;
  return t === r ? !0 : (s = t.charCodeAt(0), l = r.charCodeAt(0), s <= 90 && l >= 97 ? t === r.toUpperCase() : l <= 90 && s >= 97 ? r === t.toUpperCase() : !1);
}
function ye(n, e) {
  return !e || e === he ? g.createElement(n) : g.createElementNS(e, n);
}
function me(n, e) {
...
var q = {
  OPTION: function(n, e) {
    ...
    if (t) {
      ...
      r === "OPTGROUP" && (t = t.parentNode, r = t && t.nodeName.toUpperCase()), r === "SELECT" && !t.hasAttribute("multiple") && (n.hasAttribute("selected") && !e.selected && (n.setAttribute("selected", "selected"), n.removeAttribute("selected")), t.selectedIndex = -1);
    }
    j(n, e, "selected");
  },
  /**
   ...
   */
  INPUT: function(n, e) {
    j(n, e, "checked"), j(n, e, "disabled"), n.value !== e.value && (n.value = e.value), e.hasAttribute("value") || n.removeAttribute("value");
  },
  ...
  SELECT: function(n, e) {
    if (!e.hasAttribute("multiple")) {
      for (var t = -1, r = 0, s = n.firstChild, l, f; s; )
        if (f = s.nodeName && s.nodeName.toUpperCase(), f === "OPTGROUP")
...
function be(n) {
  return function(t, r, s) {
    if (s || (s = {}), typeof r == "string")
      if (t.nodeName === "#document" || t.nodeName === "HTML") {
        var l = r;
        r = g.createElement("html"), r.innerHTML = l;
      } else if (t.nodeName === "BODY") {
        var f = r;
        r = g.createElement("html"), r.innerHTML = f;
        var p = r.querySelector("body");
        p && (r = p);
      } else
        r = ve(r);
    else r.nodeType === K && (r = r.firstElementChild);
    var d = s.getNodeKey || we, b = s.onBeforeNodeAdded || w, T = s.onNodeAdded || w, ee = s.onBeforeElUpdated || w, te = s.onElUpdated || w, re = s.onBeforeNodeDiscarded || w, L = s.onNodeDiscarded || w, se = s.onBeforeElChildrenUpdated || w, ne = s.skipFromChildren || w, V = s.addChild || function(i, a) {
      return i.appendChild(a);
    }, x = s.childrenOnly === !0, k = /* @__PURE__ */ Object.create(null), R = [];
    function U(i) {
      R.push(i);
    }
    function B(i, a) {
      if (i.nodeType === A)
        for (var h = i.firstChild; h; ) {
          var c = void 0;
          a && (c = d(h)) ? U(c) : (L(h), h.firstChild && B(h, a)), h = h.nextSibling;
        }
    }
    function D(i, a, h) {
      re(i) !== !1 && (a && a.removeChild(i), L(i), B(i, h));
    }
    function I(i) {
      if (i.nodeType === A || i.nodeType === K)
        for (var a = i.firstChild; a; ) {
          var h = d(a);
          h && (k[h] = a), I(a), a = a.nextSibling;
        }
    }
    I(t);
    function z(i) {
      ...
      for (var a = i.firstChild; a; ) {
        ...
        if (c) {
          var o = k[c];
          o && _(a, o) ? (a.parentNode.replaceChild(o, a), O(o, a)) : z(a);
        } else
          z(a);
        a = h;
      }
    ...
    function O(i, a, h) {
      ...
      if (c && delete k[c], !h) {
        var o = ee(i, a);
        if (o === !1 || (o instanceof HTMLElement && (i = o, I(i)), n(i, a), te(i), se(i, a) === !1))
          return;
      }
      i.nodeName !== "TEXTAREA" ? ae(i, a) : q.TEXTAREA(i, a);
    }
    function ae(i, a) {
      var h = ne(i, a), c = a.firstChild, o = i.firstChild, S, v, M, N, y;
      e: for (; c; ) {
        for (N = c.nextSibling, S = d(c); !h && o; ) {
          if (M = o.nextSibling, c.isSameNode && c.isSameNode(o)) {
            c = N, o = M;
            continue e;
          }
          v = d(o);
          var H = o.nodeType, m = void 0;
          if (H === c.nodeType && (H === A ? (S ? S !== v && ((y = k[S]) ? M === y ? m = !1 : (i.insertBefore(y, o), v ? U(v) : D(
            o,
            i,
            !0
            /* skip keyed nodes */
          ), o = y, v = d(o)) : m = !1) : v && (m = !1), m = m !== !1 && _(o, c), m && O(o, c)) : (H === X || H == Y) && (m = !0, o.nodeValue !== c.nodeValue && (o.nodeValue = c.nodeValue))), m) {
            c = N, o = M;
            continue e;
          }
          v ? U(v) : D(
        ...
        if (S && (y = k[S]) && _(y, c))
          ...
          var W = b(c);
          W !== !1 && (W && (c = W), c.actualize && (c = c.actualize(i.ownerDocument || g)), V(i, c), z(c));
        }
        c = N, o = M;
      }
      ie(i, o, v);
    ...
    var u = t, C = u.nodeType, F = r.nodeType;
    if (!x) {
      if (C === A)
        F === A ? _(t, r) || (L(t), u = me(t, ye(r.nodeName, r.namespaceURI))) : u = r;
      else if (C === X || C === Y) {
        if (F === C)
    ...
    if (u === r)
      ...
      if (r.isSameNode && r.isSameNode(u))
        return;
      if (O(u, r, x), R)
        for (var P = 0, ce = R.length; P < ce; P++) {
          var $ = k[R[P]];
          $ && D($, $.parentNode, !1);
        }
    }
    return !x && u !== t && t.parentNode && (u.actualize && (u = u.actualize(t.ownerDocument || g)), t.parentNode.replaceChild(u, t)), u;
  };
}
var ke = be(oe);
class Se {
   ...
   */
  initializeWorker() {
    this.worker || (this.worker = new le(), this.worker.onmessage = (e) => {
  ...
  connect(e) {
    ...
    const t = window.location.protocol === "https:" ? "wss:" : "ws:", r = window.location.host, s = window.location.pathname, l = window.location.search, f = encodeURIComponent(s), p = l ? encodeURIComponent(l.substring(1)) : "", d = `${t}//${r}${e}?path=${f}&qs=${p}`;
    this.worker.postMessage({
      type: "connect",
      data: { url: d, expectedHost: r }
    });
  }
  /**
   ...
   * @returns {Promise<*>} Promise that resolves with reply data
   */
  callEventFrom(e, t, r = {}, s = {}) {
    return this._callEvent(e, t, r, s);
  }
  /**
  ...
  _callEvent(e, t, r, s) {
    ...
    return new Promise((f, p) => {
      const d = setTimeout(() => {
        this.pendingCalls.delete(l), p(new Error(`Call timeout: ${t}`));
      }, s.timeout || 1e4);
      this.pendingCalls.set(l, { resolve: f, reject: p, timeout: d });
      const b = {
        type: "event",
        ref_id: l,
        event: t,
  ...
  handleWorkerMessage(e) {
    ...
    try {
      ...
      this.logger?.error("Error handling worker message:", s);
    }
  }
  handleStatus(e) {
    ...
    try {
      ke(t, e.html, {
        onBeforeElUpdated(r, s) {
          return s.dataset?.arizonaUpdate === "false" ? !1 : !r.isEqualNode(s);
        }
  ...
  handleReload(e) {
    e.file_type === "css" ? (this.logger?.info("CSS file changed. Refreshing stylesheets without page reload..."), document.querySelectorAll('link[rel="stylesheet"]').forEach((t) => {
  ...
  handleReply(e) {
    const { ref_id: t, data: r } = e, s = this.pendingCalls.get(t);
    s ? (clearTimeout(s.timeout), s.resolve(r), this.pendingCalls.delete(t), this.logger?.debug(`Reply received for ref: ${t}`)) : this.logger?.warning(`Received reply for unknown ref: ${t}`);
  }
  handleRedirect(e) {
