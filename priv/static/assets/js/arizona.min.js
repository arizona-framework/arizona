...
function ce(s, e) {
  ...
  if (!(e.nodeType === J || s.nodeType === J)) {
    for (var p = t.length - 1; p >= 0; p--)
      r = t[p], n = r.name, l = r.namespaceURI, h = r.value, l ? (n = r.localName || n, g = s.getAttributeNS(l, n), g !== h && (r.prefix === "xmlns" && (n = r.name), s.setAttributeNS(l, n, h))) : (g = s.getAttribute(n), g !== h && s.setAttribute(n, h));
    for (var b = s.attributes, A = b.length - 1; A >= 0; A--)
      r = b[A], n = r.name, l = r.namespaceURI, l ? (n = r.localName || n, e.hasAttributeNS(l, n) || s.removeAttributeNS(l, n)) : e.hasAttribute(n) || s.removeAttribute(n);
  }
}
var _, le = "http://www.w3.org/1999/xhtml", f = typeof document > "u" ? void 0 : document, oe = !!f && "content" in f.createElement("template"), he = !!f && f.createRange && "createContextualFragment" in f.createRange();
function de(s) {
  var e = f.createElement("template");
  return e.innerHTML = s, e.content.childNodes[0];
}
function ue(s) {
  _ || (_ = f.createRange(), _.selectNode(f.body));
  var e = _.createContextualFragment(s);
...
function z(s, e) {
  var t = s.nodeName, r = e.nodeName, n, l;
...
var K = {
  ...
  SELECT: function(s, e) {
    if (!e.hasAttribute("multiple")) {
      for (var t = -1, r = 0, n = s.firstChild, l, h; n; )
...
function me(s) {
  return function(t, r, n) {
    ...
    var h = n.getNodeKey || ye, g = n.onBeforeNodeAdded || w, p = n.onNodeAdded || w, b = n.onBeforeElUpdated || w, A = n.onElUpdated || w, ee = n.onBeforeNodeDiscarded || w, L = n.onNodeDiscarded || w, te = n.onBeforeElChildrenUpdated || w, re = n.skipFromChildren || w, V = n.addChild || function(i, a) {
      return i.appendChild(a);
    }, H = n.childrenOnly === !0, k = /* @__PURE__ */ Object.create(null), R = [];
    function D(i) {
      R.push(i);
    }
    function B(i, a) {
    ...
    function x(i) {
      ...
      for (var a = i.firstChild; a; ) {
        ...
        if (c) {
          var o = k[c];
          o && z(a, o) ? (a.parentNode.replaceChild(o, a), O(o, a)) : x(a);
        } else
          x(a);
        a = d;
      }
    ...
    function O(i, a, d) {
      ...
      if (c && delete k[c], !d) {
        var o = b(i, a);
        if (o === !1 || (o instanceof HTMLElement && (i = o, I(i)), s(i, a), A(i), te(i, a) === !1))
          return;
      }
      i.nodeName !== "TEXTAREA" ? se(i, a) : K.TEXTAREA(i, a);
    }
    function se(i, a) {
      ...
      e: for (; c; ) {
        for (C = c.nextSibling, S = h(c); !d && o; ) {
          ...
          if (E === c.nodeType && (E === T ? (S ? S !== v && ((y = k[S]) ? M === y ? m = !1 : (i.insertBefore(y, o), v ? D(v) : U(
            o,
            i,
            !0
            /* skip keyed nodes */
          ), o = y, v = h(o)) : m = !1) : v && (m = !1), m = m !== !1 && z(o, c), m && O(o, c)) : (E === q || E == Y) && (m = !0, o.nodeValue !== c.nodeValue && (o.nodeValue = c.nodeValue))), m) {
            c = C, o = M;
            continue e;
          }
          v ? D(v) : U(
        ...
        if (S && (y = k[S]) && z(y, c))
          ...
          var W = g(c);
          W !== !1 && (W && (c = W), c.actualize && (c = c.actualize(i.ownerDocument || f)), V(i, c), x(c));
        }
        c = C, o = M;
      }
      ne(i, o, v);
    ...
    if (!H) {
      if (N === T)
        F === T ? z(t, r) || (L(t), u = ve(t, pe(r.nodeName, r.namespaceURI))) : u = r;
      else if (N === q || N === Y) {
        if (F === N)
    ...
    return !H && u !== t && t.parentNode && (u.actualize && (u = u.actualize(t.ownerDocument || f)), t.parentNode.replaceChild(u, t)), u;
  };
}
var we = me(ce);
class be {
