  ...
  return function(t, a, r) {
    ...
    function P(i) {
      ...
      for (var s = i.firstChild; s; ) {
        ...
        if (c) {
          var l = k[c];
          l && _(s, l) ? (s.parentNode.replaceChild(l, s), N(l, s)) : P(s);
        } else
          P(s);
        s = h;
      }
    ...
    function ie(i, s) {
      ...
      e: for (; c; ) {
        for (E = c.nextSibling, m = d(c); !h && l; ) {
          ...
          if (H === c.nodeType && (H === M ? (m ? m !== p && ((v = k[m]) ? S === v ? y = !1 : (i.insertBefore(v, l), p ? O(p) : z(
            l,
            i,
            !0
            /* skip keyed nodes */
          ), l = v, p = d(l)) : y = !1) : p && (y = !1), y = y !== !1 && _(l, c), y && N(l, c)) : (H === Y || H == Z) && (y = !0, l.nodeValue !== c.nodeValue && (l.nodeValue = c.nodeValue))), y) {
            c = E, l = S;
            continue e;
          }
          p ? O(p) : z(
    ...
    if (!x) {
      if (D === M)
        Q === M ? _(t, a) || (R(t), u = ye(t, ve(a.nodeName, a.namespaceURI))) : u = a;
      else if (D === Y || D === Z) {
        if (Q === D)
...
class me {
   ...
   */
  constructor(e = {}) {
    this.worker = null, this.connected = !1, this.logLevel = T[e.logLevel] ?? T.silent;
  }
  /**
