...
function me(n) {
  return function(t, r, s) {
    ...
    var h = s.getNodeKey || ye, g = s.onBeforeNodeAdded || w, p = s.onNodeAdded || w, b = s.onBeforeElUpdated || w, T = s.onElUpdated || w, ee = s.onBeforeNodeDiscarded || w, L = s.onNodeDiscarded || w, te = s.onBeforeElChildrenUpdated || w, re = s.skipFromChildren || w, B = s.addChild || function(i, a) {
    ...
    function V(i, a) {
      if (i.nodeType === A)
        for (var d = i.firstChild; d; ) {
          var c = void 0;
          a && (c = h(d)) ? U(c) : (L(d), d.firstChild && V(d, a)), d = d.nextSibling;
        }
    }
    function D(i, a, d) {
      ee(i) !== !1 && (a && a.removeChild(i), L(i), V(i, d));
    }
    function z(i) {
    ...
    function ne(i, a) {
      ...
      e: for (; c; ) {
        for (C = c.nextSibling, S = h(c); !d && o; ) {
          ...
          if (_ === c.nodeType && (_ === A ? (S ? S !== v && ((y = k[S]) ? M === y ? m = !1 : (i.insertBefore(y, o), v ? U(v) : D(
            o,
            i,
            !0
            /* skip keyed nodes */
        ...
        if (S && (y = k[S]) && H(y, c))
          ...
          var W = g(c);
          W !== !1 && (W && (c = W), c.actualize && (c = c.actualize(i.ownerDocument || f)), B(i, c), I(c));
        }
        c = C, o = M;
      }
      se(i, o, v);
    ...
    try {
      switch (t) {
        ...
        case "initial_render":
          break;
        case "html_patch":
          console.log(r), this.handleHtmlPatch(r);
          break;
        case "error":
