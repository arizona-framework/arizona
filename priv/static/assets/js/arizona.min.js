...
function me(s) {
  return function(t, r, n) {
    ...
    var h = n.getNodeKey || ye, g = n.onBeforeNodeAdded || w, p = n.onNodeAdded || w, b = n.onBeforeElUpdated || w, T = n.onElUpdated || w, ee = n.onBeforeNodeDiscarded || w, L = n.onNodeDiscarded || w, te = n.onBeforeElChildrenUpdated || w, re = n.skipFromChildren || w, V = n.addChild || function(i, a) {
    ...
    function se(i, a) {
      ...
      e: for (; c; ) {
        for (C = c.nextSibling, S = h(c); !d && o; ) {
          ...
          if (E === c.nodeType && (E === A ? (S ? S !== v && ((y = k[S]) ? M === y ? m = !1 : (i.insertBefore(y, o), v ? D(v) : U(
            o,
            i,
            !0
            /* skip keyed nodes */
