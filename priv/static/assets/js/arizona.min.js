...
function me(s) {
  return function(t, r, i) {
    ...
    }, P = i.childrenOnly === !0, b = /* @__PURE__ */ Object.create(null), R = [];
    function U(n) {
      R.push(n);
    }
    function V(n, a) {
    ...
    function C(n) {
      ...
      for (var a = n.firstChild; a; ) {
        ...
        if (c) {
          var l = b[c];
          l && I(a, l) ? (a.parentNode.replaceChild(l, a), N(l, a)) : C(a);
        } else
          C(a);
        a = h;
      }
    ...
    function N(n, a, h) {
      ...
      if (c && delete b[c], !h) {
        var l = T(n, a);
        if (l === !1 || (l instanceof HTMLElement && (n = l, _(n)), s(n, a), M(n), te(n, a) === !1))
          return;
      }
      ...
      e: for (; c; ) {
        for (H = c.nextSibling, k = d(c); !h && l; ) {
          ...
          if (z === c.nodeType && (z === A ? (k ? k !== g && ((v = b[k]) ? S === v ? y = !1 : (n.insertBefore(v, l), g ? U(g) : D(
            ...
            !0
            /* skip keyed nodes */
          ), l = v, g = d(l)) : y = !1) : g && (y = !1), y = y !== !1 && I(l, c), y && N(l, c)) : (z === q || z == Y) && (y = !0, l.nodeValue !== c.nodeValue && (l.nodeValue = c.nodeValue))), y) {
            c = H, l = S;
            continue e;
          }
          g ? U(g) : D(
        ...
        if (k && (v = b[k]) && I(v, c))
          ...
          var E = p(c);
          E !== !1 && (E && (c = E), c.actualize && (c = c.actualize(n.ownerDocument || f)), B(n, c), C(c));
        }
        c = H, l = S;
      }
      se(n, l, g);
    ...
    if (!P) {
      if (O === A)
        F === A ? I(t, r) || (L(t), u = ve(t, pe(r.nodeName, r.namespaceURI))) : u = r;
      else if (O === q || O === Y) {
        if (F === O)
    ...
    return !P && u !== t && t.parentNode && (u.actualize && (u = u.actualize(t.ownerDocument || f)), t.parentNode.replaceChild(u, t)), u;
  };
}
var we = me(ce);
class be {
