...
function ce(s, e) {
  ...
  if (!(e.nodeType === J || s.nodeType === J)) {
    ...
    for (var b = s.attributes, T = b.length - 1; T >= 0; T--)
      r = b[T], n = r.name, l = r.namespaceURI, l ? (n = r.localName || n, e.hasAttributeNS(l, n) || s.removeAttributeNS(l, n)) : e.hasAttribute(n) || s.removeAttribute(n);
  }
}
...
var K = {
   ...
   */
  INPUT: function(s, e) {
    V(s, e, "checked"), V(s, e, "disabled"), s.value !== e.value && (s.value = e.value), e.hasAttribute("value") || s.removeAttribute("value");
  },
...
function we(s) {
  return function(t, r, n) {
    ...
    var h = n.getNodeKey || ye, g = n.onBeforeNodeAdded || m, p = n.onNodeAdded || m, b = n.onBeforeElUpdated || m, T = n.onElUpdated || m, ee = n.onBeforeNodeDiscarded || m, L = n.onNodeDiscarded || m, te = n.onBeforeElChildrenUpdated || m, re = n.skipFromChildren || m, j = n.addChild || function(i, a) {
    ...
    function O(i, a, d) {
      ...
      if (c && delete k[c], !d) {
        var o = b(i, a);
        if (o === !1 || (o instanceof HTMLElement && (i = o, I(i)), s(i, a), T(i), te(i, a) === !1))
          return;
      }
    ...
    function se(i, a) {
      ...
      e: for (; c; ) {
        for (C = c.nextSibling, S = h(c); !d && o; ) {
          ...
          v = h(o);
          var E = o.nodeType, w = void 0;
          if (E === c.nodeType && (E === A ? (S ? S !== v && ((y = k[S]) ? M === y ? w = !1 : (i.insertBefore(y, o), v ? U(v) : D(
            o,
            i,
            !0
            /* skip keyed nodes */
          ), o = y, v = h(o)) : w = !1) : v && (w = !1), w = w !== !1 && z(o, c), w && O(o, c)) : (E === q || E == Y) && (w = !0, o.nodeValue !== c.nodeValue && (o.nodeValue = c.nodeValue))), w) {
            c = C, o = M;
            continue e;
          }
          v ? U(v) : D(
        ...
        if (S && (y = k[S]) && z(y, c))
          ...
          var W = g(c);
          W !== !1 && (W && (c = W), c.actualize && (c = c.actualize(i.ownerDocument || f)), j(i, c), x(c));
        }
        c = C, o = M;
      }
      ne(i, o, v);
    ...
    if (!H) {
      if (N === A)
        F === A ? z(t, r) || (L(t), u = ve(t, pe(r.nodeName, r.namespaceURI))) : u = r;
      else if (N === q || N === Y) {
        if (F === N)
