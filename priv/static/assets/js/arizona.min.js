...
function le(n, e) {
  ...
  if (!(e.nodeType === q || n.nodeType === q)) {
    ...
    for (var L = n.attributes, A = L.length - 1; A >= 0; A--)
      a = L[A], r = a.name, o = a.namespaceURI, o ? (r = a.localName || r, e.hasAttributeNS(o, r) || n.removeAttributeNS(o, r)) : e.hasAttribute(r) || n.removeAttribute(r);
  }
}
var _, oe = "http://www.w3.org/1999/xhtml", f = typeof document > "u" ? void 0 : document, he = !!f && "content" in f.createElement("template"), de = !!f && f.createRange && "createContextualFragment" in f.createRange();
function ue(n) {
...
function fe(n) {
  ...
  var e = _.createContextualFragment(n);
  ...
  return function(t, a, r) {
    if (r || (r = {}), typeof a == "string")
      if (t.nodeName === "#document" || t.nodeName === "HTML" || t.nodeName === "BODY") {
        ...
        a = ge(a);
    else a.nodeType === X && (a = a.firstElementChild);
    var d = r.getNodeKey || we, g = r.onBeforeNodeAdded || w, b = r.onNodeAdded || w, L = r.onBeforeElUpdated || w, A = r.onElUpdated || w, te = r.onBeforeNodeDiscarded || w, R = r.onNodeDiscarded || w, ae = r.onBeforeElChildrenUpdated || w, ne = r.skipFromChildren || w, V = r.addChild || function(i, s) {
      return i.appendChild(s);
    }, x = r.childrenOnly === !0, k = /* @__PURE__ */ Object.create(null), U = [];
    function O(i) {
      U.push(i);
    }
    function F(i, s) {
    ...
    function P(i) {
      ...
      for (var s = i.firstChild; s; ) {
        ...
        if (c) {
          var l = k[c];
          l && C(s, l) ? (s.parentNode.replaceChild(l, s), N(l, s)) : P(s);
        } else
          P(s);
        s = h;
      }
    ...
    function N(i, s, h) {
      ...
      if (c && delete k[c], !h) {
        var l = L(i, s);
        if (l === !1 || (l instanceof HTMLElement && (i = l, I(i)), n(i, s), A(i), ae(i, s) === !1))
          return;
      }
      i.nodeName !== "TEXTAREA" ? ie(i, s) : K.TEXTAREA(i, s);
    }
    function ie(i, s) {
      var h = ne(i, s), c = s.firstChild, l = i.firstChild, m, p, S, E, v;
      e: for (; c; ) {
        for (E = c.nextSibling, m = d(c); !h && l; ) {
          ...
          if (H === c.nodeType && (H === T ? (m ? m !== p && ((v = k[m]) ? S === v ? y = !1 : (i.insertBefore(v, l), p ? O(p) : z(
            l,
            i,
            !0
            /* skip keyed nodes */
          ), l = v, p = d(l)) : y = !1) : p && (y = !1), y = y !== !1 && C(l, c), y && N(l, c)) : (H === Y || H == Z) && (y = !0, l.nodeValue !== c.nodeValue && (l.nodeValue = c.nodeValue))), y) {
            c = E, l = S;
            continue e;
          }
          p ? O(p) : z(
    ...
    if (!x) {
      if (D === T)
        Q === T ? C(t, a) || (R(t), u = ye(t, ve(a.nodeName, a.namespaceURI))) : u = a;
      else if (D === Y || D === Z) {
        if (Q === D)
...
class me {
   ...
   */
  constructor(e = {}) {
    this.worker = null, this.connected = !1, this.logLevel = M[e.logLevel] ?? M.silent;
  }
  /**
  ...
  connect(e) {
    ...
    const t = window.location.protocol === "https:" ? "wss:" : "ws:", a = window.location.host, r = window.location.pathname, o = window.location.search, d = encodeURIComponent(r), g = o ? encodeURIComponent(o.substring(1)) : "", b = `${t}//${a}${e}?path=${d}&qs=${g}`;
