-module(arizona_parse_trans).
-moduledoc ~"""
Arizona Template Parse Transform.

Modern parse transform that replaces arizona_parse_transform. Provides
...
This module will eventually replace arizona_parse_transform.
""".
